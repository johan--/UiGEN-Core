...
$seller_account_email = 'dadmor@gmail.com';
$seller_account_email = 'marcin@karpezo.pl';
...
switch ($_GET['action']) {
   ...
   case 'process':      // Process and order...
      ...
      $p->add_field('business', $seller_account_email ); // <<-- PAYPAL SELLER ACCOUNT ID
   ...
   case 'ipn':          // Paypal is calling page for IPN validation...
      ...
      if ($p->validate_ipn()) { 
         ...
         $to = $seller_account_email;    //  your email
